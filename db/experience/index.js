...
export default [
    {
        ...
        "period": { "from": { "month": 12, "year": 2014 }, "to": "" },
        "summary": ""
    },
    {
        "title": "Expert Software Developer",
        "institution": { "url": "http://www.safira.pt", "logo": safiraLogo, "name": "SAFIRA" },
        "period": { "from": { "month": 4, "year": 2014 }, "to": { "month": 12, "year": 2014 } },
        "summary": "Continued the project for Banif mentioned on the position below, mainly in terms of bug fixing, change requests implementation, and technical assistance."
    },
    {
        "title": "Proficient Software Developer",
        "institution": { "url": "http://www.safira.pt", "logo": safiraLogo, "name": "SAFIRA" },
        "period": { "from": { "month": 4, "year": 2013 }, "to": { "month": 3, "year": 2014 } },
        "summary": `
            Developed new IT solutions for Banif (a Portuguese bank) aiming to ease the bank credit decision process.
            * Analyzed client methodologies and requirements to find the most appropriate solutions for their working model.
            * Designed and implemented several UI layout based on user experience best practices.
            ...
            * Provided technical assistance to users.
            Technologies used: IBM BPM 8.0.1, JavaScript (Client and Server side), jQuery, Bootstrap, HTML, CSS, XML, Java, and SQL Server.
        `,
    },
    {
