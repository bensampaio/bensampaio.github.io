...
export default [
    {
        ...
        "institution": { "url": "http://www.fct.unl.pt/", "logo": unlLogo, "name": "Universidade Nova de Lisboa" },
        "period": { "from": { "year": 2010 }, "to": { "year": 2013 } },
        "summary": `
            Master thesis:
            * Investigated the used of games in education and the effectiveness of collaboration as a teaching method;
    ...
    },
    {
        ...
        "institution": { "url": "http://tu-dresden.de/en", "logo": tudLogo, "name": "Technische Universität Dresden" },
