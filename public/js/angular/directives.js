(function() {
	...
	app.directive('toggleExpandCollapse', [function() {
		return {
			restrict: 'A',
	...
	app.directive('expandCollapse', [function() {
		return {
			restrict: 'A',
			link : function($scope, element, attrs) {
	...
	app.directive('sectionStatus', [ 'PATHS', function(PATHS) {
		return {
			restrict : 'E',
			emplateUrl : PATHS.views.folder + PATHS.views.elements + 'section-status.html'
		};
	}]);
