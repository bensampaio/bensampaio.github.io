        ...
        <VerticalListItem key={index}>
          <article>
            <header className="flex items-center justify-between mb-sm">
              <div>
                <h2 className="font-bold mb-xs text-2xl">{project.name}</h2>
                {project.institution?.url && (
                  <Anchor as={ExternalLink} href={project.institution.url}>
            ...
            {project.video && (
              <YouTube height="350px" src={project.video} width="100%" />
            )}
